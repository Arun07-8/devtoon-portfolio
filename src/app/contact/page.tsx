...
export default function Contact() {
  ...
  return (
    <main className="w-full bg-background selection:bg-primary/30">
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 border-b border-border overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
            ...
            <div className="lg:col-span-12 mb-16 lg:mb-24">
              <motion.div
                ...
                className="w-full"
              >
                <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.4em] text-primary mb-8 block font-mono">Inquiry // 03</span>
                <h1 className="text-fluid-h1 font-black text-foreground leading-[0.8] tracking-tighter uppercase italic text-wrap">
            ...
            <div className="lg:col-span-5 space-y-8 md:space-y-12 w-full">
              <div className="clay-industrial p-8 md:p-12 bg-card border-border hover:border-primary/20 transition-all duration-700">
                <h3 className="text-2xl font-black uppercase tracking-tighter mb-10 italic text-foreground border-b border-border pb-6">Technical HQ</h3>
                <div className="space-y-10">
                  <div className="flex items-center gap-6 group">
                    <div className="w-14 h-14 rounded-2xl bg-foreground/[0.03] border border-border flex items-center justify-center text-primary transition-all group-hover:bg-primary group-hover:text-white shadow-xl flex-shrink-0">
                      <Mail size={24} />
                    </div>
            ...
            >
              <form
                ...
                className="clay-industrial p-8 md:p-16 lg:p-20 border-border w-full bg-card shadow-2xl"
              >
                <div className="space-y-12">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
                    <div className="space-y-4">
                      ...
                      <input
                        ...
                        className="w-full bg-background/50 rounded-2xl px-8 py-5 text-sm font-black text-foreground placeholder:text-muted-foreground/30 border border-border focus:border-primary outline-none transition-all shadow-inner"
                  ...
                  <div className="space-y-4">
                    ...
                    <textarea
                      ...
                      className="w-full bg-background/50 rounded-3xl px-8 py-6 text-sm font-black text-foreground placeholder:text-muted-foreground/30 border border-border focus:border-primary outline-none transition-all resize-none shadow-inner"
                  ...
                  <motion.button
                    ...
                    type="submit"
                    disabled={sending}
                    className="btn-clay btn-clay-primary w-full h-20 md:h-24 flex items-center justify-center gap-4 text-xs font-black uppercase tracking-[0.4em] shadow-glow shadow-primary/20"
                  >
